...
public class Biomes_v1_19_R1 implements VersionAbove1_16 {
    @Override
    public boolean createBiome(MinecraftKey key, Biomes.BiomeBase base, Biomes.BiomeColor color, Biomes.Particle particle) {
        ...
        ResourceKey<BiomeBase> newKey = ResourceKey.a(IRegistry.aR, key);
        ResourceKey<BiomeBase> oldKey = ResourceKey.a(IRegistry.aR, new MinecraftKey("minecraft", "forest"));

        IRegistryWritable<BiomeBase> writableRegistry = (IRegistryWritable<BiomeBase>) dedicatedServer.aX().d(IRegistry.aR);
